...
## Election-Audit Results: 
    ...
    ```
    Once a total vote count was determined, the participating counties were determined and total votes and percentages were calculated.
    ...
    NEED PNG OF THE ELECTION RESULTS 
